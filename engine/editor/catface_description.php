...
if (!isset ($categoryFace['description'])) $categoryFace['description'] = "";
...
$(function(){
    ...
    <textarea name="description" id="description" style="width:98%;height:300px;">{$categoryFace['description']}</textarea></div></div>
HTML;
}
...
function tag_typograf() {
    ...
    <textarea name="description" id="description" class="wysiwygeditor" style="width:98%;height:300px;">{$categoryFace['description']}</textarea></div></div>
HTML;
}
